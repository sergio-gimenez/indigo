...
layout: post
date: 2020-01-27 22:10
headerImage: false
tag:
- MachineLearning
category: blog
author: sergiogimenez
description: Solving a Kaggle ML classification problem using XGBoost. A hands on approach on solving a supervised anomaly detection problem
...
![Best-Performance Feature Reduction](/assets/images/kaggle_ml/best_feature_reduction.png)
...
![Feature Importance](/assets/images/kaggle_ml/feature_importance.png)
